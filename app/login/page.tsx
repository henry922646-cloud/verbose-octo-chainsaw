...
export default async function Page() {
    return (
        <div className="flex h-screen flex-col items-center justify-center gap-3">
            <h2 className="text-2xl font-bold p-12">Sign in to Shift</h2>
            <form
                action={async () => {
                    "use server";
            ...
            >
                <button className="flex flex-row gap-4 items-center hover:bg-blue-500 bg-blue-400 hover:py-6 hover:px-8 duration-200 text-white font-medium py-4 px-6 rounded-full w-full">
                    <svg
                        width="40"
                        height="40"
                        viewBox="0 0 40 40"
